...
public class Test {
    ...
    private final String RO_HOME = "/Users/ming.yang/app/logs/"; //修改文件的路径

    private final String FILE = "5iwig.5bbrz.com_2016032005"; //修改文件的主文件名

    private final String BAK_FILE = FILE + "bak"; //修改文件的备份扩展名

    private final String PATCH_FILE = FILE + ".log"; //修改文件的扩展名
